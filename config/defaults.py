...
_C.MODEL.ID_LOSS_MARGIN = 0.3
_C.MODEL.TRIPLET_LOSS_WEIGHT = 1.0
_C.MODEL.I2T_LOSS_WEIGHT = 1.0
_C.MODEL.T2I_WEIGHT = 1.0
_C.MODEL.I2T_WEIGHT = 1.0
_C.MODEL.CONFUSION_LOSS_WEIGHT = 1.0
_C.MODEL.SEMANTIC_PROMPT_LENGTH = 8
_C.MODEL.SEMANTIC_PROMPT_DEPTH = 12
_C.MODEL.T2I_I2T_WEIGHT_PATCH = 0.
_C.MODEL.TEMPERATURE = 1.0
_C.MODEL.USE_SHARED_SEMANTIC = False
_C.MODEL.USE_PART_TOKEN_AS_QUERY = False
_C.MODEL.USE_TEMPORAL_WEIGHT = False
_C.MODEL.USE_SOFTMAX = False
_C.MODEL.WITHOUT_PE = False

_C.MODEL.CAMERA_AWARE_LOSS_MARGIN = 0.5
_C.MODEL.CAMERA_AWARE_LOSS_TOP_K = 3
_C.MODEL.CAMERA_AWARE_LOSS_WEIGHT = 0.
_C.MODEL.TRI_PART_LOSS_WEIGHT = 0.
_C.MODEL.ID_LOSS_PARTS_WEIGHT = 0.
_C.MODEL.PART_ALIGN_LOSS_WEIGHT = 0.
_C.MODEL.CROSS_PLATFORM_ALIGN_LOSS_WEIGHT = 0.
_C.MODEL.NUM_PART_LAYER = 2
_C.MODEL.NUM_PART = 4
_C.MODEL.USE_PART_MODEL = False
_C.MODEL.USE_PART_QUERY_CROSS_FRAME_ATTN = False
