...
class G2A2(object):
    def __init__(self, root=None, min_seq_len=0, split_id=0, *args, **kwargs):
        ...
        self.query_IDX_path_a2g = osp.join(self._root, 'info/query_IDX_A2G.mat')
        ...
        query_IDX_A2G = loadmat(self.query_IDX_path_a2g)['query_IDX_A2G'].squeeze()  # numpy.ndarray (1980,)
        query_IDX -= 1  # index from 0
        query_IDX_A2G -= 1
        track_query = track_test[query_IDX, :]
        track_query_a2g = track_test[query_IDX_A2G, :]
        gallery_IDX = [i for i in range(track_test.shape[0]) if i not in query_IDX]
        gallery_IDX_a2g = [i for i in range(track_test.shape[0]) if i not in query_IDX_A2G]
        track_gallery = track_test[gallery_IDX, :]
        track_gallery_a2g = track_test[gallery_IDX_a2g, :]
        ...
        # A2G
        query_a2g, num_query_tracklets_a2g, num_query_pids_a2g, num_query_imgs_a2g = \
            self._process_data(test_names, track_query_a2g, home_dir='bbox_test', relabel=False, min_seq_len=min_seq_len)

        gallery_a2g, num_gallery_tracklets_a2g, num_gallery_pids_a2g, num_gallery_imgs_a2g = \
            self._process_data(test_names, track_gallery_a2g, home_dir='bbox_test', relabel=False, min_seq_len=min_seq_len)
        ...
        self.train = train
        self.query = query
        self.query_a2g = query_a2g
        self.gallery = gallery
        self.gallery_a2g = gallery_a2g
    ...
    def _process_data(self, names, meta_data, home_dir=None, relabel=False, min_seq_len=0):
        ...
        for tracklet_idx in range(num_tracklets):
            ...
            pnames = [img_name[:5] for img_name in img_names]
            ...
            img_paths = [osp.join(self._root, home_dir, img_name[:5], img_name) for img_name in img_names]
