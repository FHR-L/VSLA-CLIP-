...
# CUDA_VISIBLE_DEVICES=0 python train_reidad apter.py --config_file output/bn-false/g2a/vsla_clip.yml
...
if __name__ == '__main__':
    ...
    if cfg.stage1weight != "":
        ...
        stage1weight = os.path.join(cfg.OUTPUT_DIR, f'ViT-B-16_stage1_{cfg.SOLVER.STAGE1.MAX_EPOCHS}.pth')
        if os.path.exists(stage1weight):
            weight_dict = torch.load(stage1weight)
