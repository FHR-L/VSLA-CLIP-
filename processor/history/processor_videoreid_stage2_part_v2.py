    ...
    for epoch in range(1, epochs + 1):
        ...
        for n_iter, (img, vid, target_cam) in enumerate(train_loader_stage2):
            ...
            if cfg.MODEL.PBP_VIEW:
                ...
                target_view = None
            with amp.autocast(enabled=True):
                score, feat, image_features, part_features_query, part_scores = model(
                    x=img,
                    label=target,
                ...
                loss = loss_fn(score, feat, target, camera_id, logits, loss_t2i, loss_i2t, part_features_query=part_features_query, part_scores=part_scores)
